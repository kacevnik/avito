...
function App() {
  ...
  const [hero, setHero] = useState('kianu')
        ...
        data: [
          {
            ...
            chat: [
              ...
              { user: 'avito_end', id: 'billy_18', mes: [{ text: { __html: '<div class="final-mess-yes">Ты прав!</div>И правда! Этот покупатель пытается выяснить у Билли личные данные — номер и код банковской карты. Разглашение такой информации ставит под угрозу финансовую и личную безопасность! Авито рекомендует держать свои личные данные при себе.' }, count: 2 }] },
          ...
          },
          {
            ...
            chat: [
              ...
              { user: 'avito_end', id: 'billy_13', mes: [{ text: { __html: '<div class="final-mess-no">Ты не прав!</div>Аккуратнее! Этот продавец отказывается встречаться лично и пытается получить предоплату за свой товар. Часто в таких случаях покупателю не удается вернуть свои деньги: продавец просто пропадает. Авито рекомендует постараться найти аналогичный товар или воспользоваться услугами проверенных продавцов и магазинов.' }, count: 2 }] },
        ...
        data: [
          {
            ...
            chat: [
              ...
              { user: 'avito_end', id: 'ilon_13', mes: [{ text: { __html: '<div class="final-mess-yes">Ты прав!</div>Для того, чтобы купить машину с рук, покупателю нужно увидеть ПТС и свидетельство о регистрации транспортного средства, таким образом он сможет проверить машину на угон или розыск (например, в <a class="tipo-lihk" style="color: #47A3F0;" href="https://autoteka.ru/?utm_medium=press&utm_source=medialeaks.ru&utm_campaign=press_medialeaks.ru_160320&utm_term=3" target="_blank">сервисе проверки “Автотека”</a>). А номера двигателя и кузова должны быть выбиты одним шрифтом и не иметь следов механической обработки (краски, сварки). Твой покупатель просто был бдительным, ведь сложно поверить, что покупаешь машину у Илона Маска!' }, count: 2 }] },
              ...
              { user: 'avito_end', id: 'ilon_16', mes: [{ text: { __html: '<div class="final-mess-no">Ты не прав!</div>Для того, чтобы купить машину с рук, покупателю нужно увидеть ПТС и свидетельство о регистрации транспортного средства, таким образом он сможет проверить машину на угон или розыск (например, <a href="https://autoteka.ru/?utm_medium=press&utm_source=medialeaks.ru&utm_campaign=press_medialeaks.ru_160320&utm_term=3" target="_blank" style="color: #47A3F0;">в сервисе проверки “Автотека”</a>). А номера двигателя и кузова должны быть выбиты одним шрифтом и не иметь следов механической обработки (краски, сварки). Твой покупатель просто был бдительным, ведь сложно поверить, что покупаешь машину у Илона Маска.' }, count: 2 }] },
        ...
        data: [
          {
            ...
            chat: [
              ...
              { user: 'he', id: 'kianu_7', mes: [{ text: { __html: 'Это легко: действуйте согласно <spna class="tipo-link">этой инструкции</spna>. А вот и мои данные: ferdishenko@icloud.com, пароль — ljcnjtdcrbqkj[. Как введете — напишите мне.' }, count: 0 }] },
              ...
              { user: 'avito_end', id: 'kianu_11', mes: [{ text: { __html: '<div class="final-mess-no">Ни за что!</div>Это распространенная схема мошенничества: вы вводите чужие данные, через несколько минут устройство блокируется, а мошенник требует деньги за разблокировку. Никогда не вводите на своем устройстве Apple чужие данные iCloud. А если обман уже произошел, ни в коем случае не отправляйте деньги на счет мошенника, пожалуйтесь в техподдержку Авито и отнесите телефон в сервисный центр Apple.' }, count: 2 }] },
